...
const Hero = () => {
  ...
  return (
    <section ref={component} className="w-full h-screen relative mx-auto">
      ...
      <div
        className={`absolute inset-0 lg:top-[250px] max-w-7xl mx-auto ${styles.paddingX} sm:flex sm:flex-wrap lg:flex lg:justify-between`}
      >
        {/* <div className="w-[22rem] relative sm:hidden order-1 mt-20 ml-24">
          <VideoCarousel />
        </div> */}

        <div className="w-[100%] h-[100%] relative order-2 -mt-10">
          <ComputersCanvas />
        </div>
      </div>
